...
const isAuthorized = (state: RootState) => state.files.authorized
const getFiles = (state: RootState) => state.files.files
const getFilesLoaded = (state: RootState) => state.files.files_loaded
const getVisibleFiles = (state: RootState) => state.files.visible_files
const getQueriedFiles = (state: RootState) => state.files.queried_files
const getSelectedFiles = (state: RootState) => state.files.selected_files
const isSelectedFile = (index: number) => ((state: RootState) => state.files.selected_files.includes(index))
const getDraggedOver = (state: RootState) => state.files.dragged_over
const getDragging = (state: RootState) => state.files.dragging
const getLoadingModal = (state: RootState) => state.files.loading_modal
